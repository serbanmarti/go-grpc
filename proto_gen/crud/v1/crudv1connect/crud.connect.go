...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/serbanmarti/go-grpc/proto_gen/crud/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	CrudServiceCreateProcedure = "/crud.v1.CrudService/Create"
	// CrudServiceReadProcedure is the fully-qualified name of the CrudService's Read RPC.
	CrudServiceReadProcedure = "/crud.v1.CrudService/Read"
	// CrudServiceUpdateProcedure is the fully-qualified name of the CrudService's Update RPC.
	CrudServiceUpdateProcedure = "/crud.v1.CrudService/Update"
	// CrudServiceDeleteProcedure is the fully-qualified name of the CrudService's Delete RPC.
	CrudServiceDeleteProcedure = "/crud.v1.CrudService/Delete"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	crudServiceServiceDescriptor      = v1.File_crud_v1_crud_proto.Services().ByName("CrudService")
...
// NewCrudServiceClient constructs a client for the crud.v1.CrudService service. By default, it uses
...
// Create calls crud.v1.CrudService.Create.
...
// Read calls crud.v1.CrudService.Read.
...
// Update calls crud.v1.CrudService.Update.
...
// Delete calls crud.v1.CrudService.Delete.
...
func NewCrudServiceHandler(svc CrudServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/crud.v1.CrudService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedCrudServiceHandler) Create(context.Context, *connect.Request[v1.CreateRequest]) (*connect.Response[v1.CreateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("crud.v1.CrudService.Create is not implemented"))
}
...
func (UnimplementedCrudServiceHandler) Read(context.Context, *connect.Request[v1.ReadRequest]) (*connect.Response[v1.ReadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("crud.v1.CrudService.Read is not implemented"))
}
...
func (UnimplementedCrudServiceHandler) Update(context.Context, *connect.Request[v1.UpdateRequest]) (*connect.Response[v1.UpdateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("crud.v1.CrudService.Update is not implemented"))
}
...
func (UnimplementedCrudServiceHandler) Delete(context.Context, *connect.Request[v1.DeleteRequest]) (*connect.Response[v1.DeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("crud.v1.CrudService.Delete is not implemented"))
}
